				...
				<ul id="accordion" class="accordion">
					<li>
						...
						<ul class="submenu">
							...
							<li><a onclick="show_insert('department')">新增院系信息</a></li>
					...
					<li>
						...
						<ul class="submenu">
							...
							<li><a onclick="show_insert('class')">新增班级信息</a></li>
					...
					<li>
						...
						<ul class="submenu">
							...
							<li><a onclick="show_insert('sc')">新增学生成绩记录</a></li>	
					...
					<li>
						...
						<ul class="submenu">
							...
							<li><a onclick="show_insert('user')">新增用户信息</a></li>	
