...
public class UserDao {
	...
	public User register(int id,String username,String password,String level) {
		Connection conn = DBUtils.getConnection();
		User user = null;
		int flag=0;
		try {
	...
	public int alter_password(String username,String old_password,String new_password){
