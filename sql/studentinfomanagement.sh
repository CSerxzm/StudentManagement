...
CREATE TABLE class (
  ...
  CONSTRAINT fk_class_department FOREIGN KEY (dno) REFERENCES department (dno) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE student (
  ...
  CONSTRAINT fk_student_class FOREIGN KEY (clno) REFERENCES class (clno) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE user (
  ...
  CONSTRAINT fk_user_student FOREIGN KEY (id) REFERENCES student (sno) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
